...
const privacyContent = {
  es: {
    ...
    content: `
      <h2>Introducción</h2>
      <p>En mp3, valoramos tu privacidad y nos comprometemos a proteger tus datos personales. Esta política de privacidad explica cómo recopilamos, usamos y protegemos tu información.</p>
      ...
      <h2>Contacto</h2>
      <p>Si tienes preguntas sobre esta política, contactanos en admin@mp3.com</p>
    `
  },
  en: {
    ...
    content: `
      <h2>Introduction</h2>
      <p>At mp3, we value your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, and protect your information.</p>
      ...
      <h2>Contact</h2>
      <p>If you have questions about this policy, contact us at admin@mp3.com</p>
    `
  },
  pt: {
    ...
    content: `
      <h2>Introdução</h2>
      <p>No mp3, valorizamos sua privacidade e nos comprometemos a proteger seus dados pessoais. Esta política de privacidade explica como coletamos, usamos e protegemos suas informações.</p>
      ...
      <h2>Contato</h2>
      <p>Se você tiver dúvidas sobre esta política, entre em contato em admin@mp3.com</p>
    `
  }
};
